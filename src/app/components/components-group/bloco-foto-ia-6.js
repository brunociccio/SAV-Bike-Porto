...
const BlocoFotoIA6Container = styled.div`
    display: flex;
...
export function BlocoFotoIA6({ subtitulo, texto, linkTexto, imagemSrc, imagemAlt }) {
    ...
    return (
        <BlocoFotoIA6Container>
            <TextoContainer>
                <Subtitulo>{subtitulo}</Subtitulo>
                <TextoIA>
                    {texto.split('<br />').map((line, index) => (
                        <span key={index}>
                            {line.includes('CHASSI') ? (
                                <>
                                    {line.split('CHASSI')[0]}
                                    <PalavraEmDestaque>CHASSI</PalavraEmDestaque>
                                    {line.split('CHASSI')[1]}
                                </>
                            ) : line}
                            <br />
